...
public class Guitarra {
    ...
    public Guitarra(String numeroSerie, String fabricante, String modelo, String tipo,
...
public static void main(String[] args) {
    ...
    // Testando os dados da classe, imprimindo a saída simples do terminal
